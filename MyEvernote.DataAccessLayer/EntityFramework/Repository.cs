...
namespace MyEvernote.DataAccessLayer.EntityFramework
{
    ...
    public class Repository<T> : RepositoryBase, IRepository<T> where T : class // Repository her gelen objenin tipini alabilmesi için generic<T> olarak tanımladık. Ayrıca int, string gibi tipte gönderilememesi için sadece class olarak filtre verdik.
    {
